...
Status: Phase 4 in progress — subphase 4.1 completed with follow-up; 4.2 next
...
| 4. Login | In progress — 4.1 completed with follow-up | Password login is committed; WhatsApp OTP with five-minute expiry is next. |
