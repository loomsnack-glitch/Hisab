...
Status: Phase 5 in progress — subphase 5.1 completed with follow-up; 5.2 next
...
| 5. Registration | In progress — 5.1 completed with follow-up | Phone/profile/password registration is committed; OTP/session is next. |
