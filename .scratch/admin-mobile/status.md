...
Status: Phase 4 started — subphase 4.1 plan ready for implementation
...
| 4. Login | In progress — 4.1 plan ready | Phase 2 UI and Phase 3 auth infrastructure are ready for password login wiring. |
