...
Status: Phase 5 in progress — subphase 5.2 completed with follow-up; 5.3 next
...
| 5. Registration | In progress — 5.2 completed with follow-up | Four-step registration and OTP/session handoff are committed; 5.3 review is next. |
