...
**What to build:** Add a read-only Stores section to the Organization Inspection Workspace, including a useful Store list and individual Store inspection. It gives a Platform Administrator Store-attributed activity and billing context plus Console-Safe Operational Metadata for Store Devices.
