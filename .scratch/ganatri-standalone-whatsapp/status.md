...
| 4 | Organization Cloud connection | 4.1–4.4 | In progress (4.3) | Embedded Signup produces a validated, encrypted Cloud account. |
...
cleanup, verification, and review are complete and committed. Phase 4.3 is
