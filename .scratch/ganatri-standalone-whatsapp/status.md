...
Status: Phase 3 review fixes complete; awaiting review-fix commit
...
- Phase 3.1 through 3.4 plans, implementation, focused verification, and
  ...
  retention. The whole-phase review fixes are complete and awaiting their
  focused commit; DB-test runtime limitations are documented in the Phase 3
  record.
...
| 3 | Ganatri Utility sender | 3.1–3.4 | Review fixes complete | Fixed bill/due messages use the common outbox safely. |
...
follow-ups. Phase 3 implementation and review fixes are complete; the review
fix commit is the final gate before Phase 4. Phases 8 and 9 are intentionally
