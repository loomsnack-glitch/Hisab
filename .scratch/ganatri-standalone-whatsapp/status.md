...
- Phase 2.1, 2.2, and 2.3 are committed. Phase 2.4 association/event
  implementation and verification are complete; its commit gate is pending.
  Phase 2.5 has not started.
...
| 2 | Policy, authorization, and Customer association foundation | 2.1–2.5 | Commit gate (2.4) | Every policy mutation, Customer association, and send path is backend-authorized. |
...
2.2, and 2.3 implementation, verification, standards/spec review, and commit
gates are complete. Phase 2.4 implementation, verification, and review are
complete; its commit gate is pending. Phase 2.5 remains blocked until that
gate. Phases 8 and 9 are intentionally deferred from the initial release.
