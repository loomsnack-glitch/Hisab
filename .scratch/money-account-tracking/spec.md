...
- Account Balance is calculated, not persisted as an editable total: Opening Balance plus the sum of positive Money Account Movements. Account detail shows the Opening Balance followed by its Movement history, linked to each Payment and Sale.
