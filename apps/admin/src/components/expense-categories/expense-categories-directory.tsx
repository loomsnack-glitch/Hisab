...
type ExpenseCategoriesDirectoryProps = {
    organizationId: string;
};

const ExpenseCategoriesDirectory = ({ organizationId }: ExpenseCategoriesDirectoryProps) => {
    ...
    return (
        <div className="flex h-full min-h-0 flex-col" data-testid="expense-categories-directory">
...
export default ExpenseCategoriesDirectory;
