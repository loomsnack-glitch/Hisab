...
export interface AntigravityProps {
  pointerRef?: RefObject<PointerState | null>;
  count?: number;
  magnetRadius?: number;
  ringRadius?: number;
  waveSpeed?: number;
...
const AntigravityInner = ({
  ...
  useFrame((state) => {
    ...
    // Use external pointer coordinates if provided; fallback to state.pointer
    ...
    // Active pointer following within hero, smooth handoff to idle animation
    ...
    // Responsive yet fluid cursor following (0.08 smoothing factor)
