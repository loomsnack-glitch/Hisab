...
import { Banknote, LayoutGrid, Pencil, PlusCircle, RefreshCw, Search, Table as TableIcon, Tags, X } from "lucide-react";

import ExpenseCategoriesDirectory from "@/components/expense-categories/expense-categories-directory";
import {
...
const ExpensesPage = () => {
    ...
    const activeTab = searchParams.get("tab") === "categories" ? "categories" : "expenses";
    ...
    return (
        <div
            className={adminWorkspacePageHeightClass}
            data-testid="expenses-page"
        >
            <Tabs
                value={activeTab}
                onValueChange={(tab) => setSearchParams(tab === "expenses" ? {} : { tab })}
            ...
            >
                <TabsList
                    ...
                    aria-label="Expenses navigation tabs"
                >
                    <TabsTrigger
                        value="expenses"
                ...
                <TabsContent
                    ...
                    data-testid="expenses-directory"
                >
                    {expensesDirectory()}
                </TabsContent>
                ...
                <TabsContent
                    value="categories"
                    className="flex min-h-0 flex-1 flex-col overflow-hidden focus-visible:outline-none"
                    data-testid="expense-categories-tab"
                >
                    <ExpenseCategoriesDirectory organizationId={organizationId} />
                </TabsContent>
            </Tabs>
        </div>
    );
