...
describe("Store workspace page", () => {
    ...
    test("registers a refresh-safe Store workspace route without replacing Organization store-detail routes", () => {
        ...
        expect(appSource).toContain('path="/organizations/:organizationId/workspaces/:storeId/devices"');
        expect(appSource).toContain('path="/organizations/:organizationId/workspaces/:storeId/settings"');
        expect(appSource).toContain('path="/organizations/:organizationId/workspaces/:storeId/license"');
