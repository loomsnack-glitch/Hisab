...
const WhatsAppOrganizationPage = () => {
    ...
    const visibleAccounts = accounts.filter(account => account.provider === "cloud_api");
    ...
    const isBusy = cloudConnectMutation.isPending || cloudRefreshMutation.isPending || cloudRegisterMutation.isPending || cloudRevokeMutation.isPending || updateTokenMutation.isPending;
