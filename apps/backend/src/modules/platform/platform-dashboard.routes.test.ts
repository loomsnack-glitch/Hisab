...
const createHarness = async () => {
    ...
    const reportingService = createPlatformReportingService({
        repository: {
            ...
            getOrganizationDetail: async () => null,
            listOrganizationStores: async () => null,
            getStoreDetail: async () => null,
            listOrganizationCatalog: async () => null,
            getOrganizationCatalogProduct: async () => null,
            getOrganizationCatalogCategory: async () => null,
            ...
            getOrganizationReportContext: async () => null,
            listOrganizationBillActivity: async () => null,
        },
        billingRepository: {
            getSaleById: async () => null,
            getSaleItemsBySaleId: async () => [],
            getPaymentsBySaleId: async () => [],
        },
        now: () => now,
    });
