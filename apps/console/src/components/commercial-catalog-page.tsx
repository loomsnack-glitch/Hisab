...
import CommercialCatalogStorefrontPage, { type CommercialCatalogStorefrontPageProps } from "@/components/commercial-catalog-storefront-page";
...
const CommercialCatalogPage = (props: CommercialCatalogPageProps) => {
    ...
    const showNav = location.kind === "features"
        || location.kind === "modules"
        || location.kind === "plans"
        || location.kind === "storefront";
    ...
    return (
        <div className="space-y-6">
            ...
            {location.kind === "storefront" ? (
                <CommercialCatalogStorefrontPage {...props} />
