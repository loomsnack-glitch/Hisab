...
const PosPrinterPage = () => {
    return (
        <div className="min-h-[calc(100dvh-var(--pos-header-height,3.5rem)-env(safe-area-inset-top,0px)-var(--pos-mobile-nav-height,0px))] max-lg:h-[calc(100dvh-var(--pos-header-height,3.5rem)-env(safe-area-inset-top,0px)-var(--pos-mobile-nav-height,0px))] lg:h-[calc(100dvh-var(--pos-header-height,3.5rem)-env(safe-area-inset-top,0px))] lg:min-h-0 lg:overflow-y-auto">
                    ...
                    <CardContent className="relative p-6 sm:p-8">
                        ...
                        <div className="relative max-w-xl space-y-2">
                            ...
                            <p className="text-sm leading-relaxed text-muted-foreground">
                                Connect a receipt printer and choose paper width for this POS device.
                            </p>
                        </div>
                    </CardContent>
                </Card>
