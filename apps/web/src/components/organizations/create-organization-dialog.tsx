                        ...
                        <FieldContent>
                            <Input
                                ...
                                {...form.register("name", {
                                    onChange: (event) => {
                                        if (!usernameEdited) {
                                            form.setValue("username", slugifyBusinessName(event.target.value), {
                                                shouldDirty: true,
                                                shouldValidate: true,
                                            });
                                        }
                            ...
                            {orgUsername ? (
                                <div className="rounded-xl border border-border/60 bg-muted/30 px-3 py-2 text-sm">
                                    <span className="text-muted-foreground">Business username preview: </span>
                                    <code className="font-mono text-foreground">{orgUsername}</code>
                                </div>
                            ) : null}
                        </FieldContent>
                    </Field>
