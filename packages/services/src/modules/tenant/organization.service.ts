...
export const getOrganizations = async (): Promise<
  ServiceResponse<OrganizationsListResponse | null>
> => {
  try {
...
export const getOrganizationCatalogSettings = async (
  ...
  try {
    const response = await api.get(
      `/organizations/${organizationId}/catalog-settings`,
    );
    return response.data;
  } catch (error) {
    return handleApiError(error);
...
export const updateOrganizationCatalogSettings = async (
  organizationId: string,
  data: UpdateOrganizationCatalogSettingsJSON,
): Promise<ServiceResponse<OrganizationCatalogSettingsResponse | null>> => {
  try {
...
export const getStoreDeviceSecret = async (
  ...
  try {
    const response = await api.get(
      `/organizations/${organizationId}/stores/${storeId}/devices/${deviceId}/secret`,
    );
    return response.data;
  } catch (error) {
    return handleApiError(error);
