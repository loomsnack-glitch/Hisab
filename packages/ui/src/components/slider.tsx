    ...
    >
      ...
      >
        <SliderPrimitive.Track
          ...
          className="bg-muted rounded-full h-1 w-full data-horizontal:h-1 data-horizontal:w-full data-vertical:h-full data-vertical:w-1 relative overflow-hidden select-none"
        >
